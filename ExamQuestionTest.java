 ...
 * @author David McDonald and Jacob Smith (tests 9 -16)
 *
 */
...
public void ex4PublicTest9() {
	...
	int expected = 0;
	int actual = numericQuestion.mark(45);
...
public void ex4PublicTest10() {
	...
	int expected = 0;
	int actual = numericQuestion.mark(20);

	assertEquals(expected, actual);
}

@Test
public void ex4PublicTest11() {

	int expected = 0;
	int actual = simpleChoiceQuestion.mark(5);

	assertEquals(expected, actual);
}

@Test
public void ex4PublicTest12() {

	int expected = 0;
	int actual = simpleChoiceQuestion.mark(4);

	assertEquals(expected, actual);
}

@Test
public void ex4PublicTest13() {

	ArrayList<Integer> givenAnswers = new ArrayList<>(Arrays.asList(2, 8));
...
@Test
public void ex4PublicTest15() {

	ArrayList<Integer> givenAnswers = new ArrayList<>(Arrays.asList(1, 2, 4));
